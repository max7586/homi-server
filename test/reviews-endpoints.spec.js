...
describe('Reviews Endpoints', function() {
  ...
  describe('POST /api/reviews', () => {
    ...
    it('creates an review, responding with 201 and the new review', function() {
      ...
      return supertest(app)
        ...
        .expect(res => {
          ...
          expect(res.body.property_id).to.eql(newReview.property_id);
        ...
        .expect(res =>
          db
            ...
            .then(row => {
              ...
              expect(row.property_id).to.eql(newReview.property_id);
    ...
    const requiredFields = ['text', 'rating', 'property_id'];
